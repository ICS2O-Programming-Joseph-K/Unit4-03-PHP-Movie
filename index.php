...
<html>
  <head>
    ...
    <meta charset="utf-8">
    <meta name="description" content="Age to Movie Ratings">
    ...
    <title>Age to Movie Ratings</title>
  ...
  <body>
    ...
    <?php echo "<h1>See What Movie Ratings your Age is Capable of Watching</h1>" ?>
    
    <!-- Text fields for user input, collects data -->
  <h3>Enter the equested information into the textfield:</h3>
  <form action="./welcome.php" method="post" target="result">
     <input type="number" step="1" min="0" max="118" name="age" id="age" placeholder="Enter age"><br><br>
						<input type="submit" value="Check movie ratings for my age">
					</form>
